...
function generateGenericPlayers(count: number): Player[] {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      ...
      photo: `https://picsum.photos/seed/player${i}/200/200`,
